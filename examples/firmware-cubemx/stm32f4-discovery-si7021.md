# STM32F4 Discovery SI7021 over I2C
...
| --- | --- | --- | --- |
| SI7021 SCL | `F4D-3` | `PB6` | `I2C1_SCL`, Open Drain, 100 kHz |
| SI7021 SDA | `F4D-4` | `PB7` | `I2C1_SDA`, Open Drain, 100 kHz |
| SI7021 VCC | `F4P-1` | `3V3` | visual power rail |
| SI7021 GND | `F4P-3` or `F4P-4` | `GND` | visual ground rail |
