# STM32F103 GPIO Lab Button -> LED

## CubeMX target

- MCU: `STM32F103RBTx` preferred
- Small GPIO-only alternative: `STM32F103C8Tx`
...
| --- | --- | --- | --- |
| Button 1 SIG | `F1A-1` | `PA0` | `GPIO_Input`, Pull-down |
| LED 1 SIG | `F1B-1` | `PB0` | `GPIO_Output`, Push Pull, Low speed |
...
```c
static const uint8_t msg[] = "F1 user firmware alive\r\n";
